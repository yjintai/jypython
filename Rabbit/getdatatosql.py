...
if __name__ == '__main__':
    ...
    #get stock concept info
    #get_concept(engine,databasename)

    #get HSGT money flow data from start_date to end_date
    get_moneyflow_hsgt(engine,databasename,'20200101',end_date)
    
    #get RZRQ margin data from start_date to end_date
    ...
    #get_daily_top_list_data from start_date to end_date
